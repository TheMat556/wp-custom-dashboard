...
export function QuickDraftWidget() {
  ...
  const handleSubmit = useCallback(
    async (values: { title: string; content: string }) => {
      ...
      try {
        // TODO(PR4): This targets the WordPress core posts endpoint, not the plugin REST
        // namespace standardized in PR3. Move it only when we introduce a separate
        // platform-level WordPress REST client for core resources.

...
export const REST_ROUTE_CONTRACTS = {
  ...
  "/chat/bootstrap": {
    ...
    requestKeys: ["selectedThreadId"],
    responseSchema: "dto/chat.bootstrap.response",
    responseKeys: ["role", "threads", "selectedThreadId", "messages", "pollIntervalSeconds"],
  },
  "/chat/poll": {
    name: "chatPoll",
    methods: ["POST"],
    ...
    requestKeys: ["selectedThreadId", "afterMessageId"],
  ...
  "/chat/send": {
    ...
    requestKeys: ["selectedThreadId", "message"],
    responseSchema: "dto/chat.send.response",
    responseKeys: ["role", "thread", "message"],
  },
  "/preferences": {
    name: "preferences",
    methods: ["GET", "POST"],
  ...
  "/activity": {
    ...
    requestKeys: ["page", "perPage", "userId", "action"],
    responseSchema: "dto/activity.response",
    responseKeys: ["entries", "total", "page", "perPage"],
  },
  "/license": {
    name: "license",
    methods: ["GET"],
  ...
  "/license/settings": {
    ...
    requestKeys: ["serverUrl"],
    responseSchema: "dto/license.settings.response",
    responseKeys: ["serverUrl", "serverConfigured", "storedLicenseKey"],
  },
  "/license/activate": {
